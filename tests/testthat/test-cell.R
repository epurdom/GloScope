...
test_that("calc_den", {
  expect_warning(distMat(sub_data_350, sample_id = "sample_id",dim_redu = "PC", ndim = 10, dens = "KNN", distmat = "KL"), "Some samples have numbers of cells smaller than the minimum cell number 500 to have reliable results!")
