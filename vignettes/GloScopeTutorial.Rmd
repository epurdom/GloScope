...
#### Potential issue with GMM

During our study, we noticed that sometimes the GMM (i.e density estimation functions from `mclust`) would fail due to lack of variance from the data. A potential solution is specifying the mclust model to be EII or VII.

```{r}
gmm_divergence_alt<-gloscope(embedding_matrix, sample_ids, dens = "GMM", GMMmodel = c("EII", "VII"))
```
